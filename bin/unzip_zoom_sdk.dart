...
Future<void> checkAndDownloadSDK(String location) async {
  ...
  if (!exists) {
    await downloadFile(
      Uri.parse(
          'https://www.dropbox.com/scl/fi/6c80i4z961hjloow3gsy0/MobileRTC?rlkey=urt3jexxia2n7ia5mmlr95ad2&st=st3hzqmk&dl=1'),
      iosSDKFile,
    );
  }
  ...
  if (!exists) {
    await downloadFile(
      Uri.parse(
          'https://www.dropbox.com/scl/fi/pix9lacdfen8msyj08dk0/MobileRTC?rlkey=wqjrvnelkynw9ryz255z094ua&st=pqkncadl&dl=1'),
      iosSimulateSDKFile,
    );
  }
